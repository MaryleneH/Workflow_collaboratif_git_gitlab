...
test_that("regrouper_pcs produit quatre grandes catégories", {
  groupes <- regrouper_pcs(c("37", "47", "54", "62", "67"))
  expect_equal(length(unique(groupes)), 4)
  expect_equal(groupes[4], groupes[5])
})
